...
image: './assets/images/2024-10-17-09-55-55-image.png'
tags: [Fleek, IPFS]
category: '运维'
draft: false 
lang: ''
...
用人话说，你可以把它看成一个共享网盘，你可以尝试下载[IPFS - Desktop（适用于有图形界面的系统）](https://github.com/ipfs/ipfs-desktop)或[kubo - ipfs（适用于CLI）](https://github.com/ipfs/kubo)。然后启动IPFS，你的设备将成为IPFS网络中的一个节点，如图![](assets/images/2024-10-17-10-47-08-image.png)
...
2. ![](assets/images/2024-10-17-11-01-49-image.png)：这种方法是原生的IPFS访问方式。通过IPFS网关+CID来访问。但由于CID为哈希值，当你的网站改动后你的CID会发生变化
...
3. 绑定自定义域名来访问，这将会使用亚马逊的CDN并且自动映射CID，实测解析IP数量超过30，并且速度很快
   ...
   - ![](assets/images/2024-10-17-11-07-40-image.png)
   
   - 尽管显示了IPFS的文件浏览界面，但实际上这个页面是由HTTP请求到亚马逊 CDN反代IPFS网络实现的，实际上仍为中心化网络
   
   - ![](assets/images/2024-10-17-11-08-44-image.png)
...
![](assets/images/2024-10-17-11-31-33-image.png)
